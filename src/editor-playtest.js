(function(root,factory){
  ...
  return Object.freeze({SESSION_KEY,PREFERENCES_KEY,SESSION_MAX_AGE_MS,PRESET_SCALES,DEFAULTS,sanitize,loadPreferences,savePreferences,beginSession,readSession,clearSession,previewMetrics,summary,mountBadge});
});
