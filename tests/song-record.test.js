...
const localInput={id:'same',title:'Local',artist:'B',bpm:130,difficultyOrder:['hard','easy','missing','hard'],charts:{hard:note('hard'),easy:note('easy'),chartOnly:note('chartOnly')},difficulties:{hard:{label:'Hard',level:8},easy:{label:'Easy',level:2}},audioMatch:{durationSeconds:3}};
