...
// Keep the signed updater release gate aligned with the committed desktop version.
...
assert.equal(tauri.version,'0.9.53');
assert.equal(pkg.version,tauri.version,'npm and desktop updater versions must match');
assert.match(cargo,/version = "0\.9\.53"/,'Rust package must match Windows 0.9.53');
