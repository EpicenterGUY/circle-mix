...
for(const file of ['pc-settings.css','src/pc-settings.js','src/ui.js','mobile-layout-v2.css','src/mobile-layout-v2.js'])if(!fs.existsSync(path.join(out,file)))throw new Error('mobile layout v2 or trackpad settings asset is missing: '+file);
