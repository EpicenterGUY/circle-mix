...
if(!desktopRelease.includes(`version:"${desktopVersion}"`)||!desktopRelease.includes(`WINDOWS ${desktopVersion}`)||!desktopRelease.includes('CircleMixChangelog')||!desktopRelease.includes('자동 계산 별 기준')||!desktopRelease.includes('다른 난이도와 채보를 그대로 보존'))throw new Error(`desktop ${desktopVersion} difficulty and editor release metadata is missing`);
