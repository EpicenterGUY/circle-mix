...
if(!desktopRelease.includes('version:"0.9.38"')||!desktopRelease.includes('PUNCHIER HIT SOUNDS')||!desktopRelease.includes('CircleMixChangelog'))throw new Error('desktop 0.9.38 release metadata is missing');
...
if(releaseWindow.CircleMixVersion?.version!=='0.9.38'||releaseWindow.CircleMixChangelog?.[0]?.version!=='0.9.38'||releaseWindow.CircleMixChangelog?.[0]?.title!=='PUNCHIER HIT SOUNDS')throw new Error('desktop release metadata override did not expose 0.9.38');
...
const seenWindow={CircleMixVersion:{version:'0.9.37'},CircleMixChangelog:[],localStorage:{getItem(){return '0.9.38';}}};
retryClickCount=0;
