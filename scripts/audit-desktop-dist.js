...
if(!desktopRelease.includes('version:"0.9.39"')||!desktopRelease.includes('PULSE MULTI-AIM GUIDANCE')||!desktopRelease.includes('CircleMixChangelog'))throw new Error('desktop 0.9.39 release metadata is missing');
...
if(releaseWindow.CircleMixVersion?.version!=='0.9.39'||releaseWindow.CircleMixChangelog?.[0]?.version!=='0.9.39'||releaseWindow.CircleMixChangelog?.[0]?.title!=='PULSE MULTI-AIM GUIDANCE')throw new Error('desktop release metadata override did not expose 0.9.39');
...
const seenWindow={CircleMixVersion:{version:'0.9.37'},CircleMixChangelog:[],localStorage:{getItem(){return '0.9.39';}}};
retryClickCount=0;
