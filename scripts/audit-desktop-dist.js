...
if(!desktopRelease.includes('version:"0.9.40"')||!desktopRelease.includes('AUTO & LARGE-ANGLE AIM FLOW')||!desktopRelease.includes('CircleMixChangelog'))throw new Error('desktop 0.9.40 release metadata is missing');
...
const releaseWindow={CircleMixVersion:{version:'0.9.37'},CircleMixChangelog:[{version:'0.9.37',title:'SIGNED UPDATER TEST'}]};
vm.runInNewContext(desktopRelease,{window:releaseWindow,Object},{filename:'desktop-dist/src/desktop-release.js'});
if(releaseWindow.CircleMixVersion?.version!=='0.9.40'||releaseWindow.CircleMixChangelog?.[0]?.version!=='0.9.40'||releaseWindow.CircleMixChangelog?.[0]?.title!=='AUTO & LARGE-ANGLE AIM FLOW')throw new Error('desktop release metadata override did not expose 0.9.40');
...
const retryWindow={CircleMixVersion:{version:'0.9.37'},CircleMixChangelog:[],localStorage:{getItem(){return '0.9.37';}}};
...
const seenWindow={CircleMixVersion:{version:'0.9.37'},CircleMixChangelog:[],localStorage:{getItem(){return '0.9.40';}}};
retryClickCount=0;
