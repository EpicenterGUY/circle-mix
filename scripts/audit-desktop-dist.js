...
if(!desktopRelease.includes('version:"0.9.46"')||!desktopRelease.includes('ALL-PLATFORM 0.9.46')||!desktopRelease.includes('CircleMixChangelog'))throw new Error('desktop 0.9.46 release metadata is missing');
...
if(releaseWindow.CircleMixVersion?.version!=='0.9.46'||releaseWindow.CircleMixChangelog?.[0]?.version!=='0.9.46'||releaseWindow.CircleMixChangelog?.[0]?.title!=='ALL-PLATFORM 0.9.46')throw new Error('desktop release metadata override did not expose 0.9.46');
...
const seenWindow={CircleMixVersion:{version:'0.9.40'},CircleMixChangelog:[],localStorage:{getItem(){return '0.9.46';}}};
retryClickCount=0;
