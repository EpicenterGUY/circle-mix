...
for(const needle of ['FLAG_KEEP_SCREEN_ON','BEHAVIOR_SHOW_TRANSIENT_BARS_BY_SWIPE','LAYOUT_IN_DISPLAY_CUTOUT_MODE_SHORT_EDGES','onBackPressedDispatcher','androidBackCallback','onConfigurationChanged','SCREEN_ORIENTATION_SENSOR_LANDSCAPE','smallestScreenWidthDp >= 600','longest >= 720 && shortest >= 480'])if(!activity.includes(needle))throw new Error(`MainActivity is missing ${needle}`);
