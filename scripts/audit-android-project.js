...
for(const needle of ['android:appCategory="game"','android:resizeableActivity="true"','android:screenOrientation="sensorLandscape"','smallestScreenSize','android.hardware.touchscreen','android.hardware.screen.landscape'])if(!manifest.includes(needle))throw new Error(`AndroidManifest is missing ${needle}`);
