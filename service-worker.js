...
const APP_SHELL_URLS = [
  ...
  "./index.html",
  "./editor.html",
  "./style.css?v=20260720-song-select-hotfix-8c",
  ...
  "./src/version.js?v=20260720-song-select-hotfix-8c",
  "./src/changelog.js?v=20260720-song-select-hotfix-8c",
  "./src/build-config.js?v=20260720-song-select-hotfix-8c",
  "./src/song-record.js?v=20260720-song-select-hotfix-8c",
  "./src/song-package-adapter.js?v=20260720-song-select-hotfix-8c",
  "./src/charts/ghost-rule.js?v=20260720-song-select-hotfix-8c",
  "./src/charts/routing.js?v=20260720-song-select-hotfix-8c",
  "./src/local-library.js?v=20260720-song-select-hotfix-8c",
  "./src/songs.js?v=20260720-song-select-hotfix-8c",
  "./src/chart.js?v=20260720-song-select-hotfix-8c",
  "./src/audio.js?v=20260720-song-select-hotfix-8c",
  "./src/effects.js?v=20260720-song-select-hotfix-8c",
  "./src/ui.js?v=20260720-song-select-hotfix-8c",
  "./src/input.js?v=20260720-song-select-hotfix-8c",
  "./src/game.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-validator.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-audio.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-zip.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-exporter.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-importer.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-local-install.js?v=20260720-song-select-hotfix-8c",
  "./src/cmix-import-ui.js?v=20260720-song-select-hotfix-8c",
  "./src/pwa.js?v=20260720-song-select-hotfix-8c"
];
